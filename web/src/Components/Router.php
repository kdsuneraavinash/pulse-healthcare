...
final class Router
{
    private static function getRoutes()
    {
        return [
            ...
            ['GET', '/control/patient', ['Pulse\Controllers\PatientControlPanelController', 'get']],
            ['GET','/control/patient/timeline',['Pulse\Controllers\PatientControlPanelController','getPatientTimelineIframe']],
            ...
            ['GET', '/control/patient/search/doctor', ['Pulse\Controllers\SearchDoctorController', 'getIframe']],
            ['POST', '/control/patient/search/doctor', ['Pulse\Controllers\SearchDoctorController', 'postIframe']],
